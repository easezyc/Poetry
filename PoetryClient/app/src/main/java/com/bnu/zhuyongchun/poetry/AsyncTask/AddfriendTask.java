...
public class AddfriendTask extends AsyncTask<String, Integer, String>{
    ...
    public AddfriendTask(OnLoginedListener listener) {
        super();
        mListener = listener;
    }
    ...
    protected String doInBackground(String... params) {//两个参数邮箱和密码
        ...
        try{
            Connection.Response res = Jsoup.connect("http://202.112.88.39:8080/PoetryServer/servlet/AddFriendServlet").data("frienduid",name).data("uid",email)//修改uid,verse
