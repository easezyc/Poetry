 ...
 */
public class ShowRememberTask extends AsyncTask<String, Integer,List<Poetry>> {
    ValueCallBack<List<Poetry>> callBack;
    public ShowRememberTask(ValueCallBack<List<Poetry>> callBack) {
        super();
    ...
    protected List<Poetry> doInBackground(String... params) {//两个参数邮箱和密码
        ...
        try{
            Connection.Response res = Jsoup.connect("http://202.112.88.39:8080/PoetryServer/servlet/LearnedPoetryServlet")
