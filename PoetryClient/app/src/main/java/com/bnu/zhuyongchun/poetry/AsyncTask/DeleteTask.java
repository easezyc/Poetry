 ...
 */
public class DeleteTask extends AsyncTask<String, Integer, PK> {
    ...
    public DeleteTask(OnLoginedListener listener) {
        super();
        mListener = listener;
    }
    ...
    protected PK doInBackground(String... params) {//两个参数邮箱和密码
        ...
        PK pk=new PK();
        try{
            Connection.Response res = Jsoup.connect("http://202.112.88.39:8080/PoetryServer/servlet/DeleteSvt")
